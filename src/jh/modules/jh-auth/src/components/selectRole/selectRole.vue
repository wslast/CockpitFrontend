...
@defaultData(Array):由父组件传过来默认选中的数据需要含有id
在每次更新数据时需要调用子组件的init方法
@selection(Function)：在父组件绑定selection事件 默认参数即为选中的项
@onelyOne(boolean):是否单选 默认False eg:<select-role
	ref="selectRole"
	@selection="function"
